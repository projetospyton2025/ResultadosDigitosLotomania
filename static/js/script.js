document.addEventListener('DOMContentLoaded', function() {
    ...
    async function fetchDigitosResults() {
        ...
        const tableBody = document.getElementById('LotomaniaResults').getElementsByTagName('tbody')[0];
    ...
    function renderResults(results) {
        ...
        if (!resultsInfoDiv) {
            ...
            const tableContainer = document.getElementById('LotomaniaResults').parentNode;
            tableContainer.insertBefore(infoDiv, document.getElementById('LotomaniaResults'));
        } else {
...
// Funções para download
 function downloadCSV() {
    ...
    link.download = 'analise_digitos_lotomania.xls';
    link.click();
}
...
function downloadJSON() {
    ...
    const link = document.createElement("a");
    link.href = URL.createObjectURL(blob);
    link.download = 'analise_digitos_lotomania.html';
    link.click();
}    
    function downloadTXT() {
        ...
        downloadFile(txtContent, 'analise_digitos_lotomania.txt', 'text/plain');
    }
