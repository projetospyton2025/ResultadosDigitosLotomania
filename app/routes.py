...
def get_resultados():
    cache_key = 'lotomania:resultados'
    ...
    try:
        logger.info(f"Buscando dados na API: {API_BASE_URL}/lotomania")
        response = requests.get(f"{API_BASE_URL}/lotomania")
